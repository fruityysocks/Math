...
\item \textbf{First Examples of Lying Over.} Let $\K$ be a field.
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item If $R\subseteq S$ is finite and $\K$ is algebraically closed, explain why the induced map on affine algebraic sets should be thought of as a finite-to-one map. Make this precise by showing that for each $\fp\in\Spec(R)$, the fibre ring $\kappa(\fp)\otimes_R S$ is finite-dimensional over $\kappa(\fp)$.
\end{enumerate}
