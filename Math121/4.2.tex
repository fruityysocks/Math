...
\begin{problem}{10}
	\textbf{Inverting an Element.} Let $R$ be a ring and let $f\in R$ be a nonzero, non-nilpotent element. Recall the ring $R[\frac{1}{f}]$ is defined to be the localization of $R$ at $U=\{1,f,f^2,f^3,\ldots\}$. 
	\begin{enumerate}
