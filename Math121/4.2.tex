...
\begin{problem}{6}
	\textbf{Field of Fractions.} Let $R$ be an integral domain. The \emph{field of fractions} of $R$ is the ring $U^{-1}R$ where $U=R\setminus\{0\}$. We denote the field of fractions of $R$ by $\Frac(R)$.
	\begin{enumerate}
...
\begin{problem}{7}
	\textbf{Universal Property of Localization.} In this exercise we shall show that $U^{-1}R$ and $\eta$ as constructed in Problem~3 satisfy the universal property of localization. Let $R$ be a ring and $U \subset R$ a multiplicatively closed subset. Let $\phi:R \to T$ be a ring homomorphism such that $\phi(U) \subset T^{\times}$.
	\begin{enumerate}
...
\begin{problem}{8}
	\textbf{Applications of the Universal Property of Localization.} Let $R$ be a ring and $U \subset R$ a multiplicatively closed subset. 
	\begin{enumerate}
...
\begin{problem}{9}
	\textbf{Localization at a Prime Ideal.} Let $R$ be a ring and $\fp \subset R$ be a prime ideal.
	\begin{enumerate}
...
\begin{problem}{10}
	\textbf{Inverting an Element.} Let $R$ be a ring and let $f\in R$ be a nonzero, non-nilpotent element. Recall the ring $R\left [\frac{1}{f} \right ]$ is defined to be the localization of $R$ at $U=\{1,f,f^2,f^3,\ldots\}$. 
	\begin{enumerate}
...
\begin{problem}{11}
	\textbf{Extension and Contraction of Ideals.} Let $\phi:R \to S$ be a homomorphism of rings. Let $I \subset R$ and $J \subset S$ be ideals.
	\begin{enumerate}
