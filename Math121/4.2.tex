...
\begin{problem}{2}
	\textbf{First Examples.} Despite not having formally verified that our construction is well-defined, discuss ways to explicitly understand $U^{-1}R$ in each of the following cases. 
	\begin{enumerate}
...
\begin{problem}{3}
	\textbf{Constructing $U^{-1}R$.} Let $R$ be a ring and $U \subset R$ a multiplicatively closed set. Define a relation on $R\times U$ by saying $(r_{1},u_{1}) \sim (r_{2},u_{2})$ if and only if $t(r_1u_{2}-r_{2}u_{1})=0$ in $R$ for some $t\in U$. 
	\begin{enumerate}
...
\begin{problem}{4}
	\textbf{First Properties of Localization.} Let $R$ be a ring and $U \subset R$ a multiplicatively closed set. 
	\begin{enumerate}
...
\begin{problem}{5}
	\textbf{The Kernel of the Localization Map.} Let $R$ be a ring, $U\subset R$ be a multiplicatively closed set, and $\eta:R \to U^{-1}R$ the localization map as described in Problem~3.
	\begin{enumerate}
