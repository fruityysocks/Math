...
\begin{solution}
    \bbni
    \begin{enumerate}
        \item If $r/1 = 0$ in $R[\frac{1}{f_i}]$ for all $i$. Then we have, $f^{n_i}_i r = 0$ for all $i$.  
    \end{enumerate}
\end{solution}
\hrulefill
...
\begin{problem}{7}
    \textbf{Nilradicals and Reduced Rings.} Let $R$ be a ring. 
    \begin{enumerate}
...
\begin{problem}{8}
    \textbf{Residue Field.} Let $R$ be a ring. Given a prime ideal $\fp \subset R$, the residue field of $R$ at $\fp$ is the ring $R_{\fp}/\fp R_{\fp}$, which we denote by $\kappa(\fp)$. 
    \begin{enumerate}
...
\begin{problem}{9}
    \textbf{Fibre Ring.} Let $\phi:R\to S$ be a ring map and fix a point $[\fp]\in \Spec(R)$. Set $U \coloneqq R \setminus \fp$ and $T\coloneqq \phi(U) \subset S$. Let $\widetilde{\phi}:R_{\fp}\longrightarrow T^{-1}S$ be the map induced by the universal property of localization discussed above. 
    \begin{enumerate}
...
\begin{problem}{10}
    \textbf{Fibres of Spec Maps.} Let $\phi:R\to S$ be a ring map and fix a point $[\fp]\in \Spec(R)$. Set $U \coloneqq R \setminus \fp$ and $T\coloneqq \phi(U) \subset S$. Let $\widetilde{\phi}:R_{\fp}\longrightarrow T^{-1}S$ be the map induced by the universal property of localization discussed above. 
    \begin{enumerate}
...
\begin{problem}{11}
    \textbf{Computing Fibres of Spec Maps.} In this problem, we use the previous exercise to compute several examples:
    \begin{enumerate}
