...
\begin{problem}{3}
    ...
    \begin{enumerate}
        ...
        \item Describe $X_U$ when $R=\CC[x,y]$ and $U=\{(xy)^n \;\; | \; \;  n\in\Z_{\geq0}\}$.
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \]
        Note that this is not open in $\Spec(\Z)$ since it is the vanishing of the equation $x - p$, that is, 
        \[\V(x-p) = \{\}\] 
    \end{enumerate}
\end{solution}
...
\begin{problem}{4}
    \textbf{Quasi-compactness of the Zariski Topology.} Let $R$ be a ring.
    \begin{enumerate}
...
\begin{problem}{5}
    \textbf{Counterexamples to Quasi-compactness of Subsets.} In the previous problem we saw that $\Spec(R)$ and every closed subset $\V(I) \subset \Spec(R)$ are quasi-compact in the Zariski topology. We also saw that when $R$ is Noetherian every open subset of $\Spec(R)$ is quasi-compact. In this exercise we explore some pathologies for open subsets when $R$ is not Noetherian.
    \begin{enumerate}
