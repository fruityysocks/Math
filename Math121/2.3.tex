...
\end{center}
    ...
    \begin{problem}{1}
        \textbf{Examples of Valuation Rings.} 
        
        Recall $\C(x,y)$ is the field of formal rational functions in $x$ and $y$, which concretely is the set of elements $f/g$ where $f,g\in \C[x,y]$ with $g\neq 0$.  For each of the following subsets $\cS \subset \C(x,y)$ determine whether or not they are valuation rings by showing whether for every $h \in \C(x,y)^{\times}$ either $h \in \cS$ or $h^{-1} \in \cS$.
        \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
            \item Hint: Use that $\C[x,y]$ is a UFD to understand when $g$ is divisible by $y$.
            \[
            \cS_{1} \coloneqq \left\{ \frac{f}{g} \;\; \big| \;\; f,g \in \C[x,y] \text{ and } g\not \in \langle y \rangle \right\}
            \]


            \item Hint: Consider the element $\frac{x}{y}$. 
            \[
            \cS_{2} \coloneqq \left\{ \frac{f}{g} \;\; \big| \;\; f,g \in \C[x,y] \text{ and } g(0,0) \neq 0 \right\}
            \]
            ...
            \[
            \cS_{3} \coloneqq \left\{ \frac{f}{g} \;\; \big| \;\; f,g \in \C[x,y], \; g\neq0, \text{ and } \ord(f) \geq \ord(g) \right\}
            \]
        \end{enumerate}
    \end{problem}
    ...
    \begin{problem}{2}
        \textbf{Ideals in Valuation Rings.} 
    ...
    \begin{problem}{3}
        \textbf{Local Rings \& Valuation Rings.} 
        
        An arbitrary ring $R$ is said to be a \emph{local ring} if it has exactly one maximal ideal. We often write a local ring $R$ as a pair $(R,\fm)$ where $\fm \subset R$ is the unique maximal ideal. 
        \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
    ...
    \begin{solution}
        \bbni
         \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
            \item $\mSpec(R) = \{m\}$
            \item the only closed point is the maximal ideal. 
            \item 
        \end{enumerate}
    \end{solution}
    ...
    \begin{problem}{4}
        ...
        Fix a prime $p$. The \emph{$p$-adic numbers} $\mathbb{Q}_p$ are the completion of $\mathbb{Q}$ with respect to the $p$-adic absolute value $|\cdot|_p$, defined as follows: for a nonzero rational number $x$, write $x = p^k \frac{a}{b}$ where $a,b \in \mathbb{Z}$ are not divisible by $p$. Then
        \[
    ...
    \begin{problem}{5}
        ...
        \item The order valuation on $\C(x)$:
        \[
        \nu_0:\C(x)^\times \to \Z,
        \quad
        ...
        \item More generally, if $a\in \C$, define
        \[
        \nu_a:\C(x)^\times \to \Z
        \]
        by order of vanishing at $x=a$. Show this is again a valuation.
        
        \item On $\C(x,y)$, define
        \[
        \nu(f/g)=\operatorname{ord}(f)-\operatorname{ord}(g),
        \]
        where $\operatorname{ord}(h)$ is the degree of the lowest-degree nonzero term of $h\in \C[x,y]$. Show that this is a valuation with value group $\Z$.
        \end{enumerate}
    \end{problem}
    ...
    \begin{problem}{7}
        \textbf{Basic Properties of Valuations.} 
    ...
    \begin{problem}{8}
        Consider the field $ \C(x, y)$. Throughout this question $\pi$ refers to the number $\pi=3.1415926...$.
        \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
        \item\label{ex-pt:val-exm1} Show that there is a unique $\C$-valuation $\nu_{\pi}:\C(x,y)^{\times} \to (\R,+)$  such that 
        \[
        \nu_{\pi}\left(x^ay^b\right) = a + \pi b.
        \]
        What is the value group of $\nu_{\pi}$? (Hint: Use Question 3.) 
        \item\label{ex-pt:val-exm2} Consider the group $\Gamma = \Z\oplus\Z$ ordered by the lexicographical ordering. Show that there exists a unique $\C$-valuation $\nu:\C(x,y)^{\times} \to \Gamma$ such that $\nu(x^ay^b)=(a,b)$. 
    ...
    \begin{problem}{9}
        \textbf{Valuations Determine Valuation Rings.}  
    ...
    \begin{problem}{10}
         \textbf{Discrete Valuation Rings.} 
    ...
    \begin{problem}{11}
        Consider the valuation $\nu_{\pi}$ on $\C(x,y)$ constructed in Question~\ref{ex-pt:val-exm1}. Let $(R,\fm)$ be the corresponding valuation ring for $\nu_{\pi}$.
        \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
    ...
    \begin{problem}{12}
        Consider the valuation $\nu$ on $\C(x,y)$ constructed in Question~\ref{ex-pt:val-exm2}. Let $(R,\fm)$ be the corresponding valuation ring for $\nu$.
        \begin{enumerate}[label=(\alph*),ref=\theenumi\alph*]
            \item Show that the maximal ideal of $R$ is
            \[
            \fm = \left\{f \in \C(x,y) \;\; \big| \;\; \nu(f) \geq  (0, 1)\right\} = \langle y \rangle.
            \]
